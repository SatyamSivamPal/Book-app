     ...
     lg:px-24 bg-teal-100 flex items-center'>
      <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
        <div className='space-y-8 md:w-1/2 h-full'>
          ...
          <p className='md:w-4/5  text-md'> Bookify is more than just a website; it's a celebration of words, a sanctuary for book lovers, and a treasure trove of literary wonders. Whether you're an avid reader, a casual browser, or a book enthusiast seeking your next great read, we've got something for everyone.</p>
          <div>
            <input type="search" name="search" id="search" placeholder='Search a book' className='py-2
                    px-3 rounded-md outline-none' />
